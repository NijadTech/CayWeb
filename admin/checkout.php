        ...
        <div class="container h-100">
            <div class="row h-100 align-items-center justify-content-center text-center">
                <div class="col-lg-10 align-self-end mb-4 page-title">
                	<h3 class="text-white">Kontrol Etmek</h3>
        ...
        <div class="card">
            <div class="card-body">
                <form action="" id="checkout">
                    <h4>Teslimat Bilgilerini Onaylayın</h4>
                    <div class="form-group">
                        <label for="" class="control-label">Adi</label>
                    ...
                    <div class="form-group">
                        <label for="" class="control-label">İlitişim</label>
                    ...
                    <div class="text-center">
                        <button class="btn btn-block btn-outline-primary">Onay</button>
                    </div>
                </form>
            </div>
        </div>
