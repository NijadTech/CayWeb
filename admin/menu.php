...
<div class="container-fluid">
	...
	<div class="col-lg-12">
		<div class="row">
			<!-- FORM Panel -->
			<div class="col-md-4">
			<form action="ajax.php?action=save_menu" id="manage-menu" >
				<div class="card">
				<div  class="col-lg-6"  > 
	  ...
	  <div class="toast-body">
					...
					<div class="card-body">
							...
							<div class="form-group">
								<div class="custom-control custom-switch">
								  ...
								  <label class="custom-control-label" for="availability">Mevcut</label>
								</div>
							</div>	
							<div class="form-group">
					...
					<div class="card-footer">
						<div class="row">
							<div class="col-md-12">
								<button type="submit" class="btn btn-sm btn-primary col-sm-3 offset-md-3"> Onay</button>
								<button class="btn btn-sm btn-default col-sm-3" type="button" onclick="$('#manage-menu').get(0).reset()"> Kapat</button>
							</div>
						</div>
					</div>
				</div>
							...
							<table class="table table-bordered table-hover">
								...
								<tbody>
									...
									<tr>
										...
										<td class="">
											<p>Adi : <b><?php echo $row['name'] ?></b></p>
											<p>Liste : <b><?php echo $row['cat'] ?></b></p>
										</td>
										<td class="text-center">
											<button class="btn btn-sm btn-primary edit_menu" type="button" data-id="<?php echo $row['id'] ?>" data-name="<?php echo $row['name'] ?>"  data-category_id="<?php echo $row['category_id'] ?>"  data-img_path="<?php echo $row['img_path'] ?>">Edit</button>
...
$.ajax({
    ...
    error: function(xhr, status, error) {
        ...
        alert_toast("Error during AJAX request", 'error');
        // Handle the error appropriately (e.g., display an error message to the user)
    },

    complete: function() {
            end_load();
			location.reload(); // Ensure that end_load is called regardless of success or error
        }
