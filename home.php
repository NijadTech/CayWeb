 ...
 <header class="masthead">
            <div class="container h-100">
                <div class="row h-100 align-items-center justify-content-center text-center">
                    <div class="col-lg-10 align-self-center mb-4 page-title">
                    	<h1 class="text-white"> <?php echo $_SESSION['setting_name']; ?></h1>
                        <hr class="divider my-4 bg-dark" />
                        <a class="btn btn-dark bg-black btn-xl js-scroll-trigger" href="#menu">sipariş ver</a>
	...
	<section class="page-section" id="menu">
                     ...
                     <div class="card menu-item  rounded-0">
                        ...
                        <div class="card-body rounded-0">
                          ...
                          <div class="text-center">
                              <button class="btn btn-sm btn-outline-dark view_prod btn-block" data-id=<?php echo $row['id'] ?>><i class="fa fa-eye"></i> Göster</button>
        ...
        <div class="w-100 mx-4 d-flex justify-content-center">
            <div class="btn-group paginate-btns">
                ...
                <a class="btn btn-default border border-dark" <?php echo ($page == 0)? 'disabled' :'' ?> href="./?_page=<?php echo ($page) ?>">önceki.</a>
                ...
                <!-- Next Page Button -->
                <a class="btn btn-default border border-dark" <?php echo (($page+1) == $page_btn_count)? 'disabled' :'' ?> href="./?_page=<?php echo ($page+2) ?>">Sonraki</a>
    ...
    <script>
        ...
        $('.view_prod').click(function(){
            uni_modal_right('Sipariş Detayları','view_prod.php?id='+$(this).attr('data-id'))
        })
    </script>
